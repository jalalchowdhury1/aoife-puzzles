...
export default function HomePage() {
  ...
  // Rematches waiting in the Practice tab (decision #23). Server first,
  // local mirror as the offline fallback — same philosophy as position.
  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-8 bg-cream p-8 text-center">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        ...
        <BigButton onClick={() => router.push("/talk")} tone="plain">
          🗣 Talk with Pip
        </BigButton>
      </div>
      <p className="text-xs text-ink/40">Talk with Pip is for Aoife and a grown up together.</p>
