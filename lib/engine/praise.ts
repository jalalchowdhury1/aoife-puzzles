...
export const PRAISE_BANK: Record<PraiseKind, string[]> & { correctFast: string[]; correctHard: string[] } = {
  ...
  correct: [
    ...
    "Pip cannot stop smiling right now.",
    "Pip is so proud of you.",
    "{name}, Pip thinks you are amazing.",
    "Pip is cheering so loudly.",
    "Pip gives you a huge high five.",
    "Everyone is proud of you right now.",
    "Pip is telling all the other foxes about you.",
    "{name}, that made Pip's whole day.",
    "Pip is jumping up and down for you.",
    "Pip thinks you might be part genius.",
    "Pip just did a little victory spin.",
    // growth
  ...
  correctFast: [
    ...
    "Zoom! You answered before Pip could even cheer.",
  ...
  miss: [
    ...
    "That is a tough format. Let Pip show you.",
    ...
    "That format is new. Let Pip show you the trick.",
  ...
  streak5: [
    ...
    "Pip has never seen a streak like this, five straight!",
  ...
  blockDone: [
    ...
    "Round complete! Pip is clapping.",
  ...
  partDone: [
    ...
    "Whole part complete, Pip is throwing confetti.",
  ...
  welcome: [
    ...
    "Welcome back, {name}! Pip missed you.",
    "Let us have some fun today, {name}.",
    "Ready to play, {name}? Pip is excited.",
    "Hello there, puzzle star!",
    "Welcome back to puzzle time!",
    "Pip has been waiting for you, {name}.",
